                    ...
                    if (segmentdiscarded == false)
                    {
                     ...
                     /*   AsyncHttpClient client = new AsyncHttpClient();
                        ...
                        isDownloaderModifyingList = true;
                            Log.i("current seg playing"," "+p.currentsegmentplaying);
                            if(segmentNo>p.currentsegmentplaying)
                        {
                            Log.i("segment accepted",""+segmentNo);
                           ...
                           for (int k = 0; k < videoList.size(); k++)
                           {
                                ...
                                if (no > segmentNo)
                                {
                                    ...
                                    int vListSize=videoList.size();
                                    for (int l = k; l < vListSize; l++)
                                    {
                            ...
                            System.out.println("sunny_videoListsort " + " " + videoList);
